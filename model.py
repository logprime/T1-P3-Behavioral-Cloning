''' 
Thanks to Udacity Instructor David Silver 
for his video Q & A on this project here http://bit.ly/2kwk5kz.
The code below is based on inputs from the tutorial as well as clone.py shown
in the lecture.
'''
...
# We have generated additional data set by using 'flipped' images 
# so model can learn from reversed images, as well as random brightness 
